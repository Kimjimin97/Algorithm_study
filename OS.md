...
>
> (_종류로는 Windows, Linux, UNIX, MS-DOS 등이 있으며, 시스템의 역할 구분에 따라 각각 용이점이 있다._)
...
- 도서 - '도전 임베디드 OS 만들기' _( 이만우 저, 인사이트 출판 )_
- 글 - '운영체제란 무엇인가?' _( https://coding-factory.tistory.com/300 )_
